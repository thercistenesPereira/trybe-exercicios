...
const wereAreYou = document.querySelector('#where-are-you');
const parentWereAreYou = wereAreYou.parentNode;
parentWereAreYou.style.color = 'darkviolet';
const firstChildOfChild = wereAreYou.lastElementChild;
firstChildOfChild.innerHTML = 'Novo texto adicionado';
