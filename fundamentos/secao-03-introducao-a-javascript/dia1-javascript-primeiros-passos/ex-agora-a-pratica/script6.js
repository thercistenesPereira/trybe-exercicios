...
let aliqotaINSS = undefined;
let aliqotaIR = undefined;

let grossSalary = 2000;

if (grossSalary <= 1556.94) {
    aliqotaINSS = grossSalary * 0.08;
} else if (grossSalary <= 2594.92) {
    aliqotaINSS = grossSalary * 0.09;
} else if (grossSalary <= 5189.82) {
    aliqotaINSS = grossSalary * 0.11;
} else {
    aliqotaINSS = 570.88;
}
console.log(aliqotaINSS);
console.log(aliqotaIR);